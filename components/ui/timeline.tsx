  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-20 pb-4 md:pb-6 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          {heading}
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm sm:text-base md:text-base max-w-sm">
          {description}
        </p>
      </div>
          ...
          >
            <div className="md:sticky static flex flex-col z-40 items-start md:top-40 top-0 self-start w-full md:w-1/2 pr-4 md:pr-4 mb-6 md:mb-0">
              <div className="flex items-center gap-4 mb-4 relative">
                ...
                <h3 className="text-xl md:text-3xl lg:text-5xl font-bold text-black dark:text-black pl-14 md:pl-14">
                  {item.title}
                </h3>
              </div>
              <div className="pl-14">
