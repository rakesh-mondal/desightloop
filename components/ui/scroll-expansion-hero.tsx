...
const ScrollExpandMedia = ({
  ...
  const mediaHeight = 400 + scrollProgress * (isMobileState ? 300 : 400)
      ...
      <section className="relative flex flex-col items-center justify-start min-h-[100dvh]">
        <div className="relative w-full flex flex-col items-center min-h-[100dvh]">
          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <div
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-xs font-medium text-white shadow-lg"
                      style={{
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white text-xs md:text-sm font-medium text-center drop-shadow-lg"
                      style={{
                        transform: `translateX(${textTranslateX}vw)`,
              ...
              >
                <motion.h2
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-white transition-none"
                  style={{
                    transform: `translateX(-${textTranslateX}vw)`,
                ...
                <motion.h2
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-center text-white transition-none"
                  style={{
                    transform: `translateX(${textTranslateX}vw)`,
                    textShadow: "0 4px 12px rgba(0, 0, 0, 0.6)",
                  }}
            ...
            {children && (
              <motion.section
                className="flex flex-col w-full px-4 py-8 md:px-8 md:py-10 lg:px-16 lg:py-20"
                initial={{ opacity: 0 }}
